...
public class ClassBookSystem {
    ...
    // ----- New method 1 -----
    // Responsibility: print the menu text only.
    // Parameters: none — it doesn't need any outside data.
    // Return type: void — it only prints, nothing to hand back.
    ...
    // ----- New method 2 -----
    // Responsibility: print which rooms are currently free.
    // Parameters: it only reads the 14 booked flags, so they come in as parameters.
    // Return type: void — it only prints, doesn't change anything.
    ...
    // ----- New method 3 -----
    // Responsibility: print which rooms are currently booked.
    // Parameters: same 14 booleans, read-only.
    // Return type: void.
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            switch (option) {
                ...
                // Book a classroom
                // NOTE: left exactly as it was — explained below why this one was NOT extracted.
                case 3:
                    System.out.println("\n--- Book a Classroom ---");
                ...
                // Unbook a classroom
                // NOTE: left exactly as it was — same reason as booking, explained below.
                case 4:
                    System.out.println("\n--- Unbook a Classroom ---");
